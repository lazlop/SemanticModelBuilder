"""
Test script converted from tutorial/testing-package.ipynb

This test script validates the complete workflow from the tutorial notebook:
1. Creates survey using s223 and validates file creation with correct headers
2. Fills survey, generates SHACL, creates semantic model, and validates against reference files
3. Loads model and validates site_info matches expected values
4. Validates get_thermostat_data returns expected data structure
"""
...
# Add the examples directory to the path to import prefill function

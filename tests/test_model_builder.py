...
class TestSemanticModelBuilder:
    ...
    def test_init_brick(
        ...
        builder = SemanticModelBuilder(
            site_id="test_site", ontology="brick", system_of_units="SI"
        )
    ...
    def test_init_s223(
        ...
        builder = SemanticModelBuilder(
            site_id="test_site", ontology="s223", system_of_units="IP"
        )
    ...
    def test_invalid_ontology(self, mock_library_load):
        ...
        with pytest.raises(Exception):
            SemanticModelBuilder(site_id="test_site", ontology="invalid")

    def test_invalid_units(self):
        """Test initialization with invalid unit system."""
        with pytest.raises(ValueError, match="Invalid system of units"):
            SemanticModelBuilder(site_id="test_site", system_of_units="invalid")
    ...
    def test_add_space(
        ...
        builder = SemanticModelBuilder(site_id="test_site")
        builder.add_space(space_id="room_101", zone_id="zone_001", area_value=25.0)

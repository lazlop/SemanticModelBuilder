...
from rdflib import Namespace, Graph, Literal as RDFLiteral, URIRef
from buildingmotif import BuildingMOTIF
from buildingmotif.dataclasses import Library, Model
from importlib.resources import files
import logging

from .namespaces import bind_prefixes, BRICK, S223, UNIT, A
...
class SemanticModelBuilder:
    ...
    def _load_templates(self) -> None:
        ...
        template_dir = str(files('semantic_mpc_interface').joinpath(f'templates/{self.ontology}-templates'))
    ...
    def add_space(
        ...
        if self.ontology == 's223':
            space_relation_dict["name-physical-space"] = self.building_ns[zone_id + '_physical_space']
